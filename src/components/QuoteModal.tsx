  ...
  useEffect(() => {
    ...
    if (initialDraft) {
      setFormData((prev) => ({ 
        ...
        contactName: initialDraft.contactName ?? prev.contactName,
        email: initialDraft.email ?? prev.email,
        phone: initialDraft.phone ?? prev.phone,
        occasion: initialDraft.occasion ?? prev.occasion,
        quantity: initialDraft.quantity ?? prev.quantity,
        selectedKitId: initialKitId || (initialDraft.selectedKitId ?? prev.selectedKitId),
        customKitItems: initialDraft.customKitItems ?? prev.customKitItems,
        brandingType: initialDraft.brandingType ?? prev.brandingType,
        boxColor: initialDraft.boxColor ?? prev.boxColor,
        brandText: initialDraft.brandText ?? prev.brandText,
        corporateMessage: initialDraft.corporateMessage ?? prev.corporateMessage,
        city: initialDraft.city ?? prev.city,
        targetDeliveryDate: initialDraft.targetDeliveryDate ?? prev.targetDeliveryDate,
        additionalNotes: initialDraft.additionalNotes ?? prev.additionalNotes,
      }));
    }
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    max="50000"
                    required
                    value={isNaN(formData.quantity) || formData.quantity === undefined ? '' : formData.quantity}
                ...
                <div>
                  ...
                  <select
                    value={formData.occasion || 'Employee Joining Kits'}
