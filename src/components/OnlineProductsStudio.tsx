...
import { PRODUCTS_CATALOG, BRAND_INFO } from '../data/giftingData';
          ...
          <div className="space-y-8 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {filteredProducts.map((product) => (
                <div
                  key={product.id}
                  className="rounded-2xl bg-stone-950 border border-stone-800 overflow-hidden flex flex-col justify-between hover:border-amber-500/40 hover:shadow-lg transition-all group"
                    ...
                    <div>
                      <div className="flex items-center justify-between text-[11px] text-amber-400 font-semibold mb-1">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-stone-300 font-bold">4.9</span>
                        </div>
                      </div>
                    ...
                    <div className="pt-2 border-t border-stone-800/80 space-y-2">
                      ...
                      <div className="flex items-center justify-between pt-1">
                        <div>
                          ...
                          <span className="font-serif text-lg font-black text-amber-200">
                            ₹{product.price}
                            <span className="text-[10px] text-stone-400 font-normal ml-1">/ unit</span>
                          </span>
                        </div>

                        <button
                          onClick={() => onOpenQuoteModal(product.name)}
                          className="px-3 py-1.5 rounded-xl bg-amber-400 hover:bg-amber-300 text-stone-950 font-bold text-xs flex items-center gap-1 transition-colors shadow-2xs"
                        >
                          <span>Get Quote</span>
