...
import { KIT_BUILDER_ITEMS } from '../data/giftingData';
import { KitBuilderItem, QuoteDraft } from '../types';

interface KitBuilderProps {
  onOpenCustomQuote: (draft: Partial<QuoteDraft>) => void;
}

export const KitBuilder: React.FC<KitBuilderProps> = ({ onOpenCustomQuote }) => {
